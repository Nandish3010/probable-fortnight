...
| `stylist/` | ADK `LlmAgent` with six tools; deterministic colour theory and role pairing (`colour.py`); apparel/selfie photo reads; JSON chat envelope on its own ADK app | §5.9 | `harness/checklists/stylist_agent.md` | `make agents` |
